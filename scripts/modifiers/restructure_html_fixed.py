...
add("The people they") # Intro to history/math
...
add("The mathematics.") # Recap with Abacus
...
add("The window is") # The window is open
...
image_injections = {
    ...
    "The window is": '<img src="../../assets/telescope.png" class="person-img cool blend-screen" alt="Telescope" />',
...
# We overwrite the actual file now
