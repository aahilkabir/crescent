...
<title>Think Like an Industry Developer — Seminar Deck</title>
<style>
:root{
...
.split{display:grid;grid-template-columns:1fr 1fr;gap:clamp(1.5rem,4vw,3.2rem);align-items:start;width:100%;}
...
.code-box-clean {
  background: #06070a;
  border: 2px solid rgba(212,162,78,.5);
  border-radius: 20px;
...
.code-box-clean.cool { border-color: rgba(41,151,255,.5); }
.code-box-clean.grn { border-color: rgba(95,211,155,.5); }
.code-box-clean.red { border-color: rgba(255,69,58,.5); }
...
<section class="slide center active">
  ...
  <div class="eyebrow reveal"><i data-lucide="qr-code"></i> SECTION 1 · SEMINAR REGISTRATION</div>
...
# Slide 1: Hero Keynote Title
slides_html.append("""
<section class="slide center">
  <div class="glow g1"></div><div class="glow g2"></div>
  <div class="eyebrow reveal"><i data-lucide="cpu"></i> KEYNOTE PRESENTATION</div>
  <h1 class="reveal">Think Like an<br><span class="grad">Industry Developer</span></h1>
  <p class="lead reveal" style="margin-top:1.8rem;">Transitioning from academic lab coding to production-grade software engineering.</p>
</section>
""")
...
<section class="slide">
  ...
  <div class="eyebrow reveal"><i data-lucide="user-check"></i> SECTION 1 · THE CORE PHILOSOPHY</div>
  <h2 class="reveal">College Mode vs. Production Mode</h2>
  <table class="table-custom reveal">
    <thead><tr><th>College Mode 🎓</th><th>Production Mode 🚀</th></tr></thead>
    <tbody>
      <tr><td>"Clear semester lab exams & pass test cases"</td><td><b>"Runs 24/7 for 1,000,000+ live active users"</b></td></tr>
      <tr><td>"Run aachis, output vandhuchu, submit pannedu"</td><td><b>"Handles network drops, timeout errors & heavy spikes"</b></td></tr>
      <tr><td>"Single run output is enough"</td><td><b>"Teammates can read, debug & refactor 6 months later"</b></td></tr>
    </tbody>
  </table>
</section>
""")
...
<section class="slide">
  ...
  <div class="eyebrow grn reveal"><i data-lucide="hard-hat"></i> SECTION 1 · DAILY REALITY</div>
  <h2 class="reveal">The "Two Hats" Principle</h2>
  <div class="split even reveal">
...
<section class="slide">
  ...
  <div class="eyebrow cool reveal"><i data-lucide="zap"></i> SECTION 1 · SCALE ANALOGY</div>
...
<section class="slide">
  <div class="glow g1"></div>
  <div class="eyebrow reveal"><i data-lucide="layers"></i> SECTION 2 · CONCEPT 1 (ABSTRACTION)</div>
...
<section class="slide">
  <div class="glow g1"></div>
  <div class="eyebrow reveal"><i data-lucide="code-2"></i> SECTION 2 · TANGLISH CODE</div>
  <h2 class="reveal">🎛️ Abstraction Layers<br><span class="grad">(Hidden Hardware Execution)</span></h2>
  <div class="code-box-clean reveal">
    <span class="cm">// High-Level Antigravity/Framework Command</span><br>
...
<section class="slide">
  <div class="glow g2"></div>
  <div class="eyebrow cool reveal"><i data-lucide="zap"></i> SECTION 2 · CONCEPT 2 (ARRAYS)</div>
...
<section class="slide">
  <div class="glow g2"></div>
  <div class="eyebrow cool reveal"><i data-lucide="code-2"></i> SECTION 2 · TANGLISH CODE</div>
  ...
  <div class="code-box-clean cool reveal">
    ...
    <span class="cm">// Address Offset Calculation: Start Address (0x1000) + (Index * Element Size)</span><br>
    <span class="kw">let</span> frontSeat = mtcBench[<span class="num">0</span>]; <span class="cm">// 0 Steps away from door -> 'Conductor'</span><br>
...
<section class="slide">
  <div class="glow g1"></div>
  <div class="eyebrow reveal"><i data-lucide="zap"></i> SECTION 2 · CONCEPT 3 (INHERITANCE)</div>
...
<section class="slide">
  ...
  <div class="code-box-clean reveal">
    ...
    <span class="kw">class</span> <span class="fn">MassHero</span> {<br>
    &nbsp;&nbsp;introWalk = <span class="str">"🔥 Slow-Motion Entry"</span>;<br>
    }<br><br>
    <span class="cm">// extends = பரம்பரைத் தொடர்ச்சி (Inherit parent capabilities)</span><br>
    <span class="kw">class</span> <span class="fn">GOATHero</span> <span class="kw">extends</span> <span class="fn">MassHero</span> {<br>
    &nbsp;&nbsp;punchLine = <span class="str">"I am waiting!"</span>; <span class="cm">// Method Override</span><br>
    }
  </div>
  <div class="kw-mapping reveal">
...
<section class="slide">
  <div class="glow g2"></div>
  <div class="eyebrow cool reveal"><i data-lucide="zap"></i> SECTION 2 · CONCEPT 4 (HASH MAPS)</div>
...
<section class="slide">
  ...
  <div class="code-box-clean cool reveal">
    ...
    <span class="cm">// O(1) Instant Direct Access</span><br>
    <span class="kw">let</span> myBike = marinaParkingMap.<span class="fn">get</span>(<span class="num">842</span>); <span class="cm">// Returns object in 0.001ms!</span>
  </div>
  <div class="kw-mapping cool reveal">
...
<section class="slide">
  <div class="glow g3"></div>
  <div class="eyebrow grn reveal"><i data-lucide="zap"></i> SECTION 2 · CONCEPT 5 (DEFENSIVE CODE)</div>
...
<section class="slide">
  <div class="glow g3"></div>
  <div class="eyebrow grn reveal"><i data-lucide="code-2"></i> SECTION 2 · TANGLISH CODE</div>
  ...
  <div class="code-box-clean grn reveal">
    ...
    &nbsp;&nbsp;<span class="fn">processOnlineBilling</span>(orderData);<br>
    } <br>
    <span class="cm">// catch = பிரச்சனை வந்தால் சமாளி (UPS Backup System)</span><br>
    <span class="kw">catch</span> (PowerCutError) {<br>
    &nbsp;&nbsp;<span class="fn">processOfflineUPSBilling</span>(orderData);<br>
    } <br>
    <span class="cm">// finally = எப்போதுமே செய் (Audit Log)</span><br>
    <span class="kw">finally</span> {<br>
    &nbsp;&nbsp;<span class="fn">syncAuditLogs</span>();<br>
    }
  </div>
...
# Slide 15: Naming Conventions
slides_html.append("""
<section class="slide">
  <div class="glow g3"></div>
  <div class="eyebrow grn reveal"><i data-lucide="check-square"></i> SECTION 3 · BEST PRACTICE #1</div>
  <h2 class="reveal">Clean Naming Conventions</h2>
  <table class="table-custom reveal">
    <thead><tr><th>Academic Trap 🎓</th><th>Industry Standard 🚀</th></tr></thead>
    <tbody>
      <tr><td class="mono">let x = a * b;</td><td class="mono">let totalBill = itemPrice * quantity;</td></tr>
    </tbody>
  </table>
...
""")
notes.append("""<b>Speaker Point:</b> Naming conventions for long term code maintainability.""")

# Slide 16: Error Handling
slides_html.append("""
<section class="slide">
  <div class="glow g4"></div>
  <div class="eyebrow red reveal"><i data-lucide="shield-alert"></i> SECTION 3 · BEST PRACTICE #2</div>
  <h2 class="reveal">Defensive Input Validation</h2>
  <table class="table-custom reveal">
    <thead><tr><th>Academic Trap 🎓</th><th>Industry Standard 🚀</th></tr></thead>
    <tbody>
      <tr><td>Assuming inputs are always perfectly valid</td><td>Strict validation bounds + graceful fallback defaults</td></tr>
    </tbody>
  </table>
...
""")
notes.append("""<b>Speaker Point:</b> Input validation and error trapping.""")

# Slide 17: Version Control
slides_html.append("""
<section class="slide">
  <div class="glow g2"></div>
  <div class="eyebrow cool reveal"><i data-lucide="git-pull-request"></i> SECTION 3 · BEST PRACTICE #3</div>
  <h2 class="reveal">Version Control &amp; Git Branching</h2>
  <table class="table-custom reveal">
    <thead><tr><th>Academic Trap 🎓</th><th>Industry Standard 🚀</th></tr></thead>
    <tbody>
      <tr><td class="mono">WhatsApp-la project_final_v2_final.zip send panradhu</td><td class="mono">Git Feature Branching (feature/login) &amp; PR Reviews</td></tr>
    </tbody>
  </table>
...
# Slide 18: REST API Verbs
slides_html.append("""
<section class="slide">
  <div class="glow g1"></div>
  <div class="eyebrow reveal"><i data-lucide="globe"></i> SECTION 3 · BEST PRACTICE #4</div>
...
# ====================================================
# SECTION 4: SEMINAR CLOSING & INTERACTIVE Q&A
# ====================================================

# Slide 19: The Impostor Syndrome Reality Check
slides_html.append("""
<section class="slide center">
  <div class="glow g1"></div>
  <div class="eyebrow reveal"><i data-lucide="smile"></i> SECTION 4 · REAL TALK</div>
...
""")
notes.append("""<b>Speaker Point:</b> Senior developers excel at problem decomposition and Google searching.""")

# Slide 20: The Developer Oath & Q&A
slides_html.append("""
<section class="slide center">
  <div class="glow g1"></div><div class="glow g2"></div>
  <div class="eyebrow reveal"><i data-lucide="heart"></i> SECTION 4 · CLOSING OATH</div>
...
""")
notes.append("""<b>Speaker Point:</b> Takeaway Developer Oath & open floor for Q&A.""")

# Slide 21: Seminar Feedback QR Slide
slides_html.append("""
<section class="slide center">
  <div class="glow g2"></div><div class="glow g3"></div>
  <div class="eyebrow cool reveal"><i data-lucide="message-square"></i> SECTION 4 · SEMINAR FEEDBACK</div>
...
# Slide 22: Certificate Download QR Slide (The Very Last Slide)
slides_html.append("""
<section class="slide center">
  <div class="glow g1"></div><div class="glow g3"></div>
  <div class="eyebrow grn reveal"><i data-lucide="award"></i> SECTION 4 · PARTICIPATION CERTIFICATE</div>
...
output_path = os.path.join(PROJECT_ROOT, "HTML", "Industry Developer", "Think Like an Industry Developer.html")

with open(output_path, "w", encoding="utf-8") as f:
    f.write(html_head + "\n".join(slides_html) + html_tail)

print(f"Successfully generated new blueprint presentation with {len(slides_html)} slides at:\n{output_path}")
